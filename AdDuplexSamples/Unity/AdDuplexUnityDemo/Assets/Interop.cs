...
public static class Interop {
	...
	public static event EventHandler ToggleBannerAdVisibility;
	...
	public static void ToggleBannerAdControl()
	{
		if (ToggleBannerAdVisibility != null)
		{
			ToggleBannerAdVisibility(null, null);			
		}		
	}	
}